...
public final class ActivitySubBinding implements ViewBinding {
  ...
  private ActivitySubBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rvProfile) {
  ...
  public static ActivitySubBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySubBinding((ConstraintLayout) rootView, rvProfile);
    }
