...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnA,
      ...
      @NonNull TextView tvMagam, @NonNull TextView tvTitle) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_magam;
      TextView tvMagam = ViewBindings.findChildViewById(rootView, id);
      if (tvMagam == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnA, imageView, imageView10,
